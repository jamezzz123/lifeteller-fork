...
interface SetDailyLimitBottomSheetProps {
  onDone: (amount: number) => void;
  onClose?: () => void;
}

export const SetDailyLimitBottomSheet = forwardRef<
  BottomSheetRef,
  SetDailyLimitBottomSheetProps
>(({ onDone, onClose }, ref) => {
...
SetDailyLimitBottomSheet.displayName = 'SetDailyLimitBottomSheet';
