...
type LiftTypeModalProps = {
  visible: boolean;
  currentType: LiftType;
  currentAmount: number;
  currentItems: LiftItem[];
  onDone: (type: LiftType, amount: number, items: LiftItem[]) => void;
  onClose: () => void;
};

export function LiftTypeModal({
  visible,
  currentType,
  currentAmount,
  currentItems,
  ...
  const [selectedType, setSelectedType] = useState<LiftType>(currentType);
  ...
  }, [visible, currentType, currentAmount, currentItems]);
