...
import { ReportAndBlockConfirmationModal } from '@/components/profile/ReportAndBlockConfirmationModal';
...
export default function ReportAndBlockUserScreen() {
  ...
  const handleConfirm = () => {
    ...
    console.log('Report and block user:', {
      userId,
      username,
  ...
  return (
    <SafeAreaView className="flex-1 bg-white" edges={['top', 'bottom']}>
      ...
      <ReportAndBlockConfirmationModal
