  ...
  return (
    <SafeAreaView className="flex-1 bg-background" edges={['top', 'bottom']}>
      ...
      <ConfirmDialog
        ...
        title="Unsave all saved posts"
        message="Are you sure you want to unsave all saved posts?"
        confirmText="Yes, unsave"
        cancelText="No"
        onConfirm={() => {
          // TODO: Unsave all posts
          console.log('Unsaving all saved posts');
          setShowConfirmDialog(false);
          // TODO: Clear the saved posts list or navigate back
          router.back();
        }}
        onCancel={() => {
          setShowConfirmDialog(false);
